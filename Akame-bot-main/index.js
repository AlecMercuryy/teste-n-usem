...
/******** OWNER NUMBER**********/
const ownerNumber = ["5512992297222@s.whatsapp.net","5512992297222@s.whatsapp.net"] 
/************************************/
...
case 'spam':
    			if (!isRegistered) return reply(ind.noregis())
		    		if (isLimit(sender)) return reply(ind.limitend(pusname))
			     	await limitAdd(sender)	    				    					     	
                    if (args.length < 1) return reply(`Use assim:  exemplo : ${prefix}spam 5512992297222 corno`)
...
break
		    ...
		    ow = "5512992297222@s.whatsapp.net"
		    cuy = "5512992297222@s.whatsapp.net"
                    menusu = `
❏ *GRUPO MENU*
│
└◪› ${prefix}welcome [1/0]
...
break
    ...
    case 'transferi':
                ...
                addKoinUser('5512992297222@s.whatsapp.net', fee)
